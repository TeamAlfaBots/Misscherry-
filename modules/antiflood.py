...
@Client.on_message(filters.command("setfloodtimer") & filters.group & admin_filter)
...
@Client.on_message(filters.command("floodmode") & filters.group & admin_filter)
...
@Client.on_message(filters.command("clearflood") & filters.group & admin_filter)
...
@Client.on_message(filters.group & ~filters.service & ~filters.command(""))
