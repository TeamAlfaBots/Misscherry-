...
@Client.on_message(filters.command("approval") & ~filters.private)
...
@Client.on_message(filters.command("approve") & ~filters.private & admin_filter)
...
@Client.on_message(filters.command("unapprove") & ~filters.private & admin_filter)
...
@Client.on_message(filters.command("unapproveall") & ~filters.private)
