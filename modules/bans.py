...
@Client.on_message(filters.command(["ban", "dban", "sban"]) & filters.group & admin_filter)
...
@Client.on_message(filters.command("tban") & filters.group & admin_filter)
...
@Client.on_message(filters.command(["mute", "dmute", "smute"]) & filters.group & admin_filter)
...
@Client.on_message(filters.command("tmute") & filters.group & admin_filter)
...
@Client.on_message(filters.command(["kick", "dkick", "skick"]) & filters.group & admin_filter)
