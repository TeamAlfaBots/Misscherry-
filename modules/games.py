...
@Client.on_message(filters.command("wordseek") & ~filters.private)
...
@Client.on_message(filters.command("wordchain") & ~filters.private)
...
@Client.on_message(filters.command("hangman") & ~filters.private)
...
@Client.on_message(filters.command("guess") & ~filters.private)
...
@Client.on_message(filters.command("solve") & ~filters.private)
...
@Client.on_message(filters.command("wordle") & ~filters.private)
...
@Client.on_message(filters.command("crossword") & ~filters.private)
...
@Client.on_message(filters.command("answer") & ~filters.private)
