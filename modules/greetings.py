...
@Client.on_message(filters.command("welcome") & filters.group & admin_filter)
...
@Client.on_message(filters.command("goodbye") & filters.group & admin_filter)
...
@Client.on_message(filters.command("resetwelcome") & filters.group & admin_filter)
...
@Client.on_message(filters.command("setgoodbye") & filters.group & admin_filter)
...
@Client.on_message(filters.command("resetgoodbye") & filters.group & admin_filter)
...
@Client.on_message(filters.command("cleanwelcome") & filters.group & admin_filter)
