...
@Client.on_message(filters.command(["warn", "dwarn", "swarn"]) & filters.group & admin_filter)
...
@Client.on_message(filters.command("rmwarn") & filters.group & admin_filter)
...
@Client.on_message(filters.command("resetwarn") & filters.group & admin_filter)
...
@Client.on_message(filters.command("resetallwarns") & filters.group & admin_filter)
...
@Client.on_message(filters.command("warnmode") & filters.group & admin_filter)
...
@Client.on_message(filters.command("warnlimit") & filters.group & admin_filter)
...
@Client.on_message(filters.command("warntime") & filters.group & admin_filter)
